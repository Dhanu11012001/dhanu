...
exports.deprecatedMessage = 'Warning: ADAL has been deprecated, and is scheduled to be removed in a future release. Please use MSAL instead.';
exports.loadLocalizedConstants = (locale) => {
    ...
    exports.authTypeName = localize(34, null);
    exports.authTypeIntegrated = localize(35, null);
    exports.authTypeSql = localize(36, null);
    exports.authTypeAzureActiveDirectory = localize(37, null);
    exports.azureAuthTypeCodeGrant = localize(38, null);
    exports.azureAuthTypeDeviceCode = localize(39, null);
    exports.azureLogChannelName = localize(40, null);
    exports.azureConsentDialogOpen = localize(41, null);
    exports.azureConsentDialogCancel = localize(42, null);
    exports.azureConsentDialogIgnore = localize(43, null);
    exports.azureConsentDialogBody = localize(44, null);
    exports.azureConsentDialogBodyAccount = localize(45, null);
    ...
    exports.msgAuthTypeNotFound = localize(121, null);
    exports.msgAccountNotFound = localize(122, null);
    exports.msgChooseQueryHistory = localize(123, null);
    exports.msgChooseQueryHistoryAction = localize(124, null);
    exports.msgOpenQueryHistory = localize(125, null);
    exports.msgRunQueryHistory = localize(126, null);
    exports.msgInvalidIpAddress = localize(127, null);
    exports.msgNoQueriesAvailable = localize(128, null);
    exports.retryLabel = localize(129, null);
    exports.createFirewallRuleLabel = localize(130, null);
    exports.msgConnecting = localize(131, null);
    exports.msgConnectionNotFound = localize(132, null);
    exports.msgFoundPendingReconnect = localize(133, null);
    exports.msgPendingReconnectSuccess = localize(134, null);
    exports.msgFoundPendingReconnectFailed = localize(135, null);
    exports.msgFoundPendingReconnectError = localize(136, null);
    exports.msgAcessTokenExpired = localize(137, null);
    exports.msgRefreshTokenError = localize(138, null);
    exports.msgAzureCredStoreSaveFailedError = localize(139, null);
    exports.msgRefreshConnection = localize(140, null);
    exports.msgRefreshTokenSuccess = localize(141, null);
    exports.msgRefreshTokenNotNeeded = localize(142, null);
    exports.msgConnectedServerInfo = localize(143, null);
    exports.msgConnectionFailed = localize(144, null);
    exports.msgChangingDatabase = localize(145, null);
    exports.msgChangedDatabase = localize(146, null);
    exports.msgDisconnected = localize(147, null);
    exports.macOpenSslErrorMessage = localize(148, null);
    exports.macOpenSslHelpButton = localize(149, null);
    exports.macSierraRequiredErrorMessage = localize(150, null);
    exports.gettingDefinitionMessage = localize(151, null);
    exports.definitionRequestedStatus = localize(152, null);
    exports.definitionRequestCompletedStatus = localize(153, null);
    exports.updatingIntelliSenseStatus = localize(154, null);
    exports.intelliSenseUpdatedStatus = localize(155, null);
    exports.testLocalizationConstant = localize(156, null);
    exports.disconnectOptionLabel = localize(157, null);
    exports.disconnectOptionDescription = localize(158, null);
    exports.disconnectConfirmationMsg = localize(159, null);
    exports.elapsedBatchTime = localize(160, null);
    exports.noActiveEditorMsg = localize(161, null);
    exports.maximizeLabel = localize(162, null);
    exports.restoreLabel = localize(163, null);
    exports.saveCSVLabel = localize(164, null);
    exports.saveJSONLabel = localize(165, null);
    exports.saveExcelLabel = localize(166, null);
    exports.fileTypeCSVLabel = localize(167, null);
    exports.fileTypeJSONLabel = localize(168, null);
    exports.fileTypeExcelLabel = localize(169, null);
    exports.resultPaneLabel = localize(170, null);
    exports.selectAll = localize(171, null);
    exports.copyLabel = localize(172, null);
    exports.copyWithHeadersLabel = localize(173, null);
    exports.executeQueryLabel = localize(174, null);
    exports.QueryExecutedLabel = localize(175, null);
    exports.messagePaneLabel = localize(176, null);
    exports.messagesTableTimeStampColumn = localize(177, null);
    exports.messagesTableMessageColumn = localize(178, null);
    exports.lineSelectorFormatted = localize(179, null);
    exports.elapsedTimeLabel = localize(180, null);
    exports.msgCannotSaveMultipleSelections = localize(181, null);
    exports.mssqlProviderName = localize(182, null);
    exports.noneProviderName = localize(183, null);
    exports.flavorChooseLanguage = localize(184, null);
    exports.flavorDescriptionMssql = localize(185, null);
    exports.flavorDescriptionNone = localize(186, null);
    exports.msgAddConnection = localize(187, null);
    exports.msgConnect = localize(188, null);
    exports.azureSignIn = localize(189, null);
    exports.azureSignInDescription = localize(190, null);
    exports.azureSignInWithDeviceCode = localize(191, null);
    exports.azureSignInWithDeviceCodeDescription = localize(192, null);
    exports.azureSignInToAzureCloud = localize(193, null);
    exports.azureSignInToAzureCloudDescription = localize(194, null);
    exports.taskStatusWithName = localize(195, null);
    exports.taskStatusWithMessage = localize(196, null);
    exports.taskStatusWithNameAndMessage = localize(197, null);
    exports.failed = localize(198, null);
    exports.succeeded = localize(199, null);
    exports.succeededWithWarning = localize(200, null);
    exports.canceled = localize(201, null);
    exports.inProgress = localize(202, null);
    exports.canceling = localize(203, null);
    exports.notStarted = localize(204, null);
    exports.nodeErrorMessage = localize(205, null);
    exports.deleteCredentialError = localize(206, null);
    exports.msgClearedRecentConnectionsWithErrors = localize(207, null);
    exports.connectProgressNoticationTitle = localize(208, null);
    exports.msgMultipleSelectionModeNotSupported = localize(209, null);
    exports.newColumnWidthPrompt = localize(210, null);
    exports.columnWidthInvalidNumberError = localize(211, null);
    exports.columnWidthMustBePositiveError = localize(212, null);
    exports.objectExplorerNodeRefreshError = localize(213, null);
    exports.showOutputChannelActionButtonText = localize(214, null);
    exports.reloadPrompt = localize(215, null);
    exports.reloadChoice = localize(216, null);
    exports.deprecatedMessage = localize(217, null);
};
