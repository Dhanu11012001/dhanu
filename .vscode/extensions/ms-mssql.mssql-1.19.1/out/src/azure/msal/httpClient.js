...
const networkRequestViaHttps = (urlString, httpMethod, options, agentOptions, timeout) => {
    ...
    const optionHeaders = (options === null || options === void 0 ? void 0 : options.headers) || {};
    let customOptions = Object.assign({ method: httpMethod, headers: optionHeaders }, NetworkUtils_1.NetworkUtils.urlToHttpOptions(url));
    if (timeout) {
