...
class ConnectionUI {
    ...
    createFirewallRule(serverName, ipAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = yield this._vscodeWrapper.showInformationMessage(LocalizedConstants.msgPromptRetryFirewallRuleSignedIn, LocalizedConstants.createFirewallRuleLabel);
    ...
    addNewAccount() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.connectionManager.azureController.addAccount(this._accountStore);
        });
    }
