...
class ConnectionProfile extends connectionCredentials_1.ConnectionCredentials {
    ...
    static createProfile(prompter, connectionStore, context, azureController, accountStore, defaultProfileValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            questions.push({
                ...
                shouldPrompt: () => !profile.connectionString && connectionCredentials_1.ConnectionCredentials.isPasswordBasedCredential(profile),
                ...
                onAnswered: (value) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (value !== 'addAccount') {
                        ...
                        tenantChoices.push(...(_a = account === null || account === void 0 ? void 0 : account.properties) === null || _a === void 0 ? void 0 : _a.tenants.map(t => ({ name: t.displayName, value: t })));
                ...
                shouldPrompt: () => profile.isAzureActiveDirectory() && tenantChoices.length > 1 && !utils_1.getEnableSqlAuthenticationProviderConfig(),
                onAnswered: (value) => {
    ...
    static getAzureAuthChoices() {
        let choices = [
            { name: LocalizedConstants.azureAuthTypeCodeGrant, value: utils.azureAuthTypeToString(azure_1.AzureAuthType.AuthCodeGrant) },
            { name: LocalizedConstants.azureAuthTypeDeviceCode, value: utils.azureAuthTypeToString(azure_1.AzureAuthType.DeviceCode) }
        ];
        return choices;
    }
